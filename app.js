...
const CONFIG = {
  ...
  recentPurchases: [
    { name: 'Marie D.',   product: 'vient de commander QZ01',  delay: 9000  },
    { name: 'Thomas R.',  product: 'vient de commander DR02',  delay: 24000 },
    { name: 'Sophie M.',  product: 'vient de commander AL11',  delay: 42000 },
    { name: 'Lucas B.',   product: 'vient de commander JB07',  delay: 60000 },
    { name: 'Emma L.',    product: 'vient de commander QZ01',  delay: 78000 },
    { name: 'Noah C.',    product: 'vient de commander DR02',  delay: 96000 },
  ],
};
...
function initPurchasePopup() {
  ...
  CONFIG.recentPurchases.forEach(({ name, product, delay }) => {
    setTimeout(() => {
      const pn = DOM.ppName();     if (pn) pn.textContent = name;
      const pp = DOM.ppProduct();  if (pp) pp.textContent = product;
